...
ROOT_APP_PACKAGE_demo := com.sinlov.kotlin.android.demo
ROOT_APP_LAUNCHER_ACTIVITY_demo := com.sinlov.kotlin.android.demo.MainActivity
ROOT_APP_LANCHER_PARAMS_demo :="-a android.intent.action.MAIN -c android.intent.category.LAUNCHER"

demoTasks:
	${ENV_GRADLE_WRAPPER_EXEC} -q $(ROOT_APP_NAME_demo):tasks
...
demoTestDebug:
	${ENV_GRADLE_WRAPPER_EXEC} -q $(ROOT_APP_NAME_demo):testDebugUnitTest

demoTestRelease: demoClean
	${ENV_GRADLE_WRAPPER_EXEC} -q $(ROOT_APP_NAME_demo):testReleaseUnitTest
